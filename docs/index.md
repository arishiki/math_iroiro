...
$$
\int _ {\bigcup _ {m \leq n} C _ m} f\circ g |J_g|d\mu =
\sum _ {m \leq n} \lbrace \int _ {C _ m} f\circ g |J_g|d\mu -
\int _ {C _ m \cap \bigcup _ {l \lt m} C _ l} f\circ g |J_g|d\mu\rbrace.
$$

一方，$C _ m \cap \bigcup _ {l \lt m} C _ l  = \bigcup _ {l \lt m} C _ l \cap C _ m$ であり，各 $l \lt m$ に対し $C _ l \cap C _ m$ は測度 0 だから，
$\int _ {C _ m \cap \bigcup _ {l \lt m} C _ l} f\circ g |J_g|d\mu = 0$ であり，
$$
\int _ {\bigcup _ {m \leq n} C _ m} f\circ g |J_g|d\mu =
\sum _ {m \leq n} \int _ {C _ m} f\circ g |J_g|d\mu.
$$

非負単調収束定理により，
$$
\int _ {\bigcup _ {n \in \mathbb{N}} C _ n} f\circ g |J_g|d\mu =
\sum _ {n \in \mathbb{N}} \int _ {C _ n} f\circ g |J_g|d\mu.
$$

$A \setminus \bigcup _ {n \in \mathbb{N}} C _ n \subset A \setminus A'$ かつ
 $\mu(A \setminus A') = 0$ より，
$$
\int _ {\bigcup _ {n \in \mathbb{N}} C _ n} f\circ g |J_g|d\mu = 
